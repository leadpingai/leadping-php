...
namespace Leadping\OpenApiClient\Businesses\Invitations\Accept;

use Exception;
use Http\Promise\Promise;
use Leadping\OpenApiClient\Models\AcceptBusinessInvitationRequest;
...
class AcceptRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/businesses/invitations/accept');
     ...
     * @param AcceptBusinessInvitationRequest $body Request payload for accept business invitation.
     ...
     * @throws Exception
    */
    public function post(AcceptBusinessInvitationRequest $body, ?AcceptRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(AcceptBusinessInvitationRequest $body, ?AcceptRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
