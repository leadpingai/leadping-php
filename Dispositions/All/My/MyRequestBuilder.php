...
namespace Leadping\OpenApiClient\Dispositions\All\My;

use Exception;
use Http\Promise\Promise;
use Leadping\OpenApiClient\Models\PagedResultOfDispositionResponse;
...
class MyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/dispositions/all/my');
     ...
     * @return Promise<PagedResultOfDispositionResponse|null>
     * @throws Exception
    */
    public function post(RequestDataOptions $body, ?MyRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [PagedResultOfDispositionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
