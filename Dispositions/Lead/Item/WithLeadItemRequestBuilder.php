...
namespace Leadping\OpenApiClient\Dispositions\Lead\Item;

use Exception;
use Http\Promise\Promise;
use Leadping\OpenApiClient\Dispositions\Lead\Item\Export\ExportRequestBuilder;
...
class WithLeadItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/dispositions/lead/{leadId}');
    ...
    */
    public function toGetRequestInformation(?WithLeadItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
