...
namespace Leadping\OpenApiClient\Events\Conversations\Item;

use Exception;
use Http\Promise\Promise;
use Leadping\OpenApiClient\Events\Conversations\Item\Notes\NotesRequestBuilder;
...
class WithConversationItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/events/conversations/{conversationId}');
     ...
     * @throws Exception
    */
    public function post(RequestDataOptions $body, ?WithConversationItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(RequestDataOptions $body, ?WithConversationItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
