...
use Leadping\OpenApiClient\Models\PagedResultOfLeadTableRow;
...
class MyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/leads/all/my{?archiveFilter*,tagIds*,tagMatchAll*,untagged*}');
    ...
    */
    public function post(RequestDataOptions $body, ?MyRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [PagedResultOfLeadTableRow::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
