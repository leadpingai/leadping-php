...
class AcceptOrganizationInvitationRequest implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $token The token supplied to authorize or complete this organization invitation.
    */
    private ?string $token = null;
    
    /**
     * Instantiates a new AcceptOrganizationInvitationRequest and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AcceptOrganizationInvitationRequest {
