...
*/
class AutomationRequestSnapshot implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $description Human-readable description that explains this automation request snapshot to API users.
    */
    private ?string $description = null;
    
    /**
     * @var bool|null $enabled Indicates whether this automation request snapshot is active and available in the Leadping API.
    */
    private ?bool $enabled = null;
    
    /**
     * @var string|null $id Unique Leadping identifier for this automation request snapshot.
    */
    private ?string $id = null;
    
    /**
     * @var bool|null $isSystemManaged Indicates whether Leadping manages this automation request snapshot automatically instead of a user.
    */
    ...
    */
    ...
    /**
     * @var string|null $visibility Visibility level that controls who can see this automation request snapshot.
    */
    private ?string $visibility = null;
    
    /**
     * Instantiates a new AutomationRequestSnapshot and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AutomationRequestSnapshot {
