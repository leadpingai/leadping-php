...
*/
class BusinessInvitationTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $licenseQuantity The quantity on the shared business user license subscription item after this change.
    */
    ...
    */
    ...
    /**
     * Instantiates a new BusinessInvitationTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BusinessInvitationTableRow {
