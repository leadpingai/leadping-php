...
class CreateNoteRequest implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * Instantiates a new CreateNoteRequest and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateNoteRequest {
