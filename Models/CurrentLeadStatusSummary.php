...
*/
class CurrentLeadStatusSummary implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var CurrentLeadStatusSummary_category|null $category Controlled lead status change categories used for reporting, automation, and analytics.
    */
    private ?CurrentLeadStatusSummary_category $category = null;
    
    /**
     * @var DateTime|null $changedAt UTC timestamp when the lead status change last changed.
    */
    private ?DateTime $changedAt = null;
    
    /**
     * @var string|null $changedByAutomationId Automation ID that last changed the lead status change.
    */
    private ?string $changedByAutomationId = null;
    
    /**
     * @var string|null $changedByUserId User ID of the person who last changed the lead status change.
    */
    private ?string $changedByUserId = null;
    
    /**
     * @var string|null $displayName Human-readable display name shown for this current lead status change summary.
    */
    private ?string $displayName = null;
    
    /**
     * @var string|null $id Unique Leadping identifier for this current lead status change summary.
    */
    private ?string $id = null;
    
    /**
     * @var string|null $outcome Current lead status change outcome assigned to the lead.
    */
    private ?string $outcome = null;
    
    /**
     * @var CurrentLeadStatusSummary_source|null $source Known sources that can change a lead's current lead status change.
    */
    private ?CurrentLeadStatusSummary_source $source = null;
    
    /**
     * Instantiates a new CurrentLeadStatusSummary and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CurrentLeadStatusSummary {
    ...
    */
     ...
     * @return CurrentLeadStatusSummary_category|null
    */
    public function getCategory(): ?CurrentLeadStatusSummary_category {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'category' => fn(ParseNode $n) => $o->setCategory($n->getEnumValue(CurrentLeadStatusSummary_category::class)),
            ...
            'source' => fn(ParseNode $n) => $o->setSource($n->getEnumValue(CurrentLeadStatusSummary_source::class)),
        ];
    }
    ...
    */
     ...
     * @return CurrentLeadStatusSummary_source|null
    */
    public function getSource(): ?CurrentLeadStatusSummary_source {
        return $this->source;
    }
    ...
    */
     ...
     * @param CurrentLeadStatusSummary_category|null $value Value to set for the category property.
    */
    public function setCategory(?CurrentLeadStatusSummary_category $value): void {
        $this->category = $value;
    }
    ...
    */
     ...
     * @param CurrentLeadStatusSummary_source|null $value Value to set for the source property.
    */
    public function setSource(?CurrentLeadStatusSummary_source $value): void {
        $this->source = $value;
    }
