...
class ExactMatchFilter implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * Instantiates a new ExactMatchFilter and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ExactMatchFilter {
