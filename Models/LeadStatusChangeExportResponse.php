...
class LeadStatusChangeExportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<LeadStatusChangeExportRow>|null $rows The rows included with this lead status change export.
    */
    private ?array $rows = null;
    
    /**
     * Instantiates a new LeadStatusChangeExportResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): LeadStatusChangeExportResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'rows' => fn(ParseNode $n) => $o->setRows($n->getCollectionOfObjectValues([LeadStatusChangeExportRow::class, 'createFromDiscriminatorValue'])),
        ];
    }
    ...
    */
     ...
     * @return array<LeadStatusChangeExportRow>|null
    */
    ...
    */
     ...
     * @param array<LeadStatusChangeExportRow>|null $value Value to set for the rows property.
    */
