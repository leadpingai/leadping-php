...
*/
class OrganizationDunningInfo implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var DateTime|null $finalCancellationAt Date and time when this Leadping organization dunning info was final cancellation.
    */
    private ?DateTime $finalCancellationAt = null;
    
    /**
     * @var DateTime|null $gracePeriodEndsAt Date and time when this Leadping organization dunning info was grace period ends.
    */
    private ?DateTime $gracePeriodEndsAt = null;
    
    /**
     * @var string|null $lastFailedInvoiceStatus Current last failed invoice status for this Leadping organization dunning info.
    */
    private ?string $lastFailedInvoiceStatus = null;
    
    /**
     * @var DateTime|null $lastUpdatedAt Date and time when this Leadping organization dunning info was last updated.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $outboundRestrictedAt Date and time when this Leadping organization dunning info was outbound restricted.
    */
    private ?DateTime $outboundRestrictedAt = null;
    
    /**
     * @var DateTime|null $outboundSuspendedAt Date and time when this Leadping organization dunning info was outbound suspended.
    */
    private ?DateTime $outboundSuspendedAt = null;
    
    /**
     * @var DateTime|null $paymentFailedAt Date and time when this Leadping organization dunning info was payment failed.
    */
    ...
    */
    ...
    /**
     * Instantiates a new OrganizationDunningInfo and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): OrganizationDunningInfo {
