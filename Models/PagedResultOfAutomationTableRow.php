...
*/
class PagedResultOfAutomationTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<AutomationTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfAutomationTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfAutomationTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([AutomationTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<AutomationTableRow>|null
    */
    ...
    */
     ...
     * @param array<AutomationTableRow>|null $value Value to set for the items property.
    */
