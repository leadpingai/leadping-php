...
*/
class PagedResultOfBusinessTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<BusinessTableRow>|null $items The subset of items returned for the current page.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfBusinessTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfBusinessTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([BusinessTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<BusinessTableRow>|null
    */
    ...
    */
     ...
     * @param array<BusinessTableRow>|null $value Value to set for the items property.
    */
