...
*/
class PagedResultOfConversationResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<ConversationResponse>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfConversationResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfConversationResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([ConversationResponse::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<ConversationResponse>|null
    */
    ...
    */
     ...
     * @param array<ConversationResponse>|null $value Value to set for the items property.
    */
