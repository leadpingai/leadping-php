...
*/
class PagedResultOfDispositionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<DispositionResponse>|null $items The subset of items returned for the current page.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfDispositionResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfDispositionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([DispositionResponse::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<DispositionResponse>|null
    */
    ...
    */
     ...
     * @param array<DispositionResponse>|null $value Value to set for the items property.
    */
