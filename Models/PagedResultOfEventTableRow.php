...
*/
class PagedResultOfEventTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<EventTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfEventTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfEventTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([EventTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<EventTableRow>|null
    */
    ...
    */
     ...
     * @param array<EventTableRow>|null $value Value to set for the items property.
    */
