...
*/
class PagedResultOfFeedbackResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<FeedbackResponse>|null $items The subset of items returned for the current page.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfFeedbackResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfFeedbackResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([FeedbackResponse::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<FeedbackResponse>|null
    */
    ...
    */
     ...
     * @param array<FeedbackResponse>|null $value Value to set for the items property.
    */
