...
*/
class PagedResultOfLeadTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<LeadTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfLeadTableRow {
    ...
    */
     ...
     * @return array<LeadTableRow>|null
    */
    ...
    */
     ...
     * @param array<LeadTableRow>|null $value Value to set for the items property.
    */
