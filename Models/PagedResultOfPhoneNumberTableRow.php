...
*/
class PagedResultOfPhoneNumberTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<PhoneNumberTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfPhoneNumberTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfPhoneNumberTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([PhoneNumberTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<PhoneNumberTableRow>|null
    */
    ...
    */
     ...
     * @param array<PhoneNumberTableRow>|null $value Value to set for the items property.
    */
