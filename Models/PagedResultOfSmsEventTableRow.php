...
*/
class PagedResultOfSmsEventTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<SmsEventTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfSmsEventTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfSmsEventTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([SmsEventTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<SmsEventTableRow>|null
    */
    ...
    */
     ...
     * @param array<SmsEventTableRow>|null $value Value to set for the items property.
    */
