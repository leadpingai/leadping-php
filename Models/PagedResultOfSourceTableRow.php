...
*/
class PagedResultOfSourceTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<SourceTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfSourceTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfSourceTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([SourceTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<SourceTableRow>|null
    */
    ...
    */
     ...
     * @param array<SourceTableRow>|null $value Value to set for the items property.
    */
