...
*/
class PagedResultOfSuppressionEntryResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<SuppressionEntryResponse>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfSuppressionEntryResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfSuppressionEntryResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([SuppressionEntryResponse::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<SuppressionEntryResponse>|null
    */
    ...
    */
     ...
     * @param array<SuppressionEntryResponse>|null $value Value to set for the items property.
    */
