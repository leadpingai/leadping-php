...
*/
class PagedResultOfTransactionTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<TransactionTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfTransactionTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfTransactionTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([TransactionTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<TransactionTableRow>|null
    */
    ...
    */
     ...
     * @param array<TransactionTableRow>|null $value Value to set for the items property.
    */
