...
*/
class PagedResultOfUsageLedgerTableRow implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<UsageLedgerTableRow>|null $items Items included in the current page, in the order determined by the query.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PagedResultOfUsageLedgerTableRow and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PagedResultOfUsageLedgerTableRow {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([UsageLedgerTableRow::class, 'createFromDiscriminatorValue'])),
     ...
     * @return array<UsageLedgerTableRow>|null
    */
    ...
    */
     ...
     * @param array<UsageLedgerTableRow>|null $value Value to set for the items property.
    */
