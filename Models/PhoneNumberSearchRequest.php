...
*/
class PhoneNumberSearchRequest implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $phoneNumber Phone number used by this phone number search request for calls, SMS, lookup, or routing.
    */
    private ?string $phoneNumber = null;
    
    /**
     * Instantiates a new PhoneNumberSearchRequest and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PhoneNumberSearchRequest {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'location' => fn(ParseNode $n) => $o->setLocation($n->getObjectValue([PhoneNumberSearchRequest_location::class, 'createFromDiscriminatorValue'])),
