...
class PhoneNumberStatusResponse_smsWarmup extends SmsWarmupStatusResponse implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PhoneNumberStatusResponse_smsWarmup {
        return new PhoneNumberStatusResponse_smsWarmup();
    }
