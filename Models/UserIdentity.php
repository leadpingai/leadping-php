...
class UserIdentity implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $issuer Identity provider or tenant that issued the sign-in identity, such as contoso.com or facebook.com.
    */
    private ?string $issuer = null;
    
    /**
     * @var string|null $issuerAssignedId Stable unique user identifier assigned by the identity provider within the issuer's namespace.
    */
    private ?string $issuerAssignedId = null;
    
    /**
     * @var string|null $signInType Sign-in method represented by the identity, such as emailAddress, userName, or federated.
    */
