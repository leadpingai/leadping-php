...
namespace Leadping\OpenApiClient\Notifications\UnreadCount;
...
*/
class UnreadCountRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/notifications/unread-count');
    ...
    */
    public function toGetRequestInformation(?UnreadCountRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return UnreadCountRequestBuilder
    */
    public function withUrl(string $rawUrl): UnreadCountRequestBuilder {
        return new UnreadCountRequestBuilder($rawUrl, $this->requestAdapter);
    }
