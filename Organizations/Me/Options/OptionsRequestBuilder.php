...
namespace Leadping\OpenApiClient\Organizations\Me\Options;

use Exception;
use Http\Promise\Promise;
use Leadping\OpenApiClient\Models\OrganizationSwitchOption;
...
class OptionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/organizations/me/options');
     ...
     * @return Promise<array<OrganizationSwitchOption>|null>
     * @throws Exception
    */
    public function get(?OptionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendCollectionAsync($requestInfo, [OrganizationSwitchOption::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
