...
namespace Leadping\OpenApiClient\Sources\All;

use Leadping\OpenApiClient\Sources\All\My\MyRequestBuilder;
...
class AllRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/sources/all');
