...
use Leadping\OpenApiClient\Models\PagedResultOfSuppressionEntryResponse;
...
class MyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/suppressions/all/my');
    ...
    */
    public function post(RequestDataOptions $body, ?MyRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [PagedResultOfSuppressionEntryResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
