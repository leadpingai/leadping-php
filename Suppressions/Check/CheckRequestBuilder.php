...
use Leadping\OpenApiClient\Models\SuppressionCheckResult;
...
class CheckRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/suppressions/check');
     ...
     * @throws Exception
    */
    public function post(SuppressionEntryRequest $body, ?CheckRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toPostRequestInformation($body, $requestConfiguration);
        $errorMappings = [
                '400' => [ProblemDetails::class, 'createFromDiscriminatorValue'],
                '401' => [ProblemDetails::class, 'createFromDiscriminatorValue'],
        ];
        return $this->requestAdapter->sendAsync($requestInfo, [SuppressionCheckResult::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toPostRequestInformation(SuppressionEntryRequest $body, ?CheckRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
