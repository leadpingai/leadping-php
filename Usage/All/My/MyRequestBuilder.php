...
namespace Leadping\OpenApiClient\Usage\All\My;

use Exception;
use Http\Promise\Promise;
use Leadping\OpenApiClient\Models\PagedResultOfUsageLedgerTableRow;
...
class MyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/usage/all/my');
    ...
    */
    public function post(RequestDataOptions $body, ?MyRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [PagedResultOfUsageLedgerTableRow::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
