...
namespace Leadping\OpenApiClient\Users\Compliance;

use Exception;
use Http\Promise\Promise;
use Leadping\OpenApiClient\Models\ComplianceUpdateRequest;
...
class ComplianceRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/compliance');
     ...
     * @param ComplianceUpdateRequest $body Defines the input used for compliance update.
     ...
     * @throws Exception
    */
    public function put(ComplianceUpdateRequest $body, ?ComplianceRequestBuilderPutRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPutRequestInformation(ComplianceUpdateRequest $body, ?ComplianceRequestBuilderPutRequestConfiguration $requestConfiguration = null): RequestInformation {
